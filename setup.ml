...
(* OASIS_START *)
(* DO NOT EDIT (digest: 11e2bd5e33606cbe453b45474659f11a) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_angstrom", []))];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/inhabitedtype/angstrom";
          bugreports = None;
          synopsis =
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build benchmark executables";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Angstrom"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "angstrom";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Angstrom_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "angstrom";
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "lwt", OASISExpr.EFlag "unix"),
                             true)
                        ];
                      bs_install =
                        [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_angstrom.ml"});
               Executable
                 ({
                     cs_name = "pure_benchmark";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "pure_benchmark.ml"});
               Executable
                 ({
                     cs_name = "async_benchmark";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "angstrom";
                           InternalLibrary "angstrom_async";
                           FindlibPackage ("async", None);
                           FindlibPackage ("threads", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                   ...
                   {exec_custom = false; exec_main_is = "async_benchmark.ml"});
               Executable
                 ({
                     cs_name = "lwt_benchmark";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "angstrom";
                           InternalLibrary "angstrom_lwt_unix";
                           FindlibPackage ("lwt.unix", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                   ...
                   {exec_custom = false; exec_main_is = "lwt_benchmark.ml"});
               Test
                 ({
                     cs_name = "test_angstrom";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\1653\249:/[\026 \145\135\212|\251\194*\213";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
